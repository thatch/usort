...
@click.option(
    "--threads",
    is_flag=True,
    help="Use a single process with threads instead of spawned multiprocess",
)
def main(benchmark: bool, threads: bool) -> None:
    global BENCHMARK
    BENCHMARK = benchmark
    ...
    if threads:
        ...
        from . import sorting as sorting

        sorting.RUNNER = trailrunner.Trailrunner(executor_factory=ThreadPoolExecutor)
